...
app.get('/get_config', function(req, res){
    ...
    var content = `{ "hostname":"esphost", "wifi-ssid":"mySSID", "wifi-password":"mywifi-pass", "broker-address":"broker-address", "broker-user":"broker-user", "broker-password":"broker-password", "broker-update-interval":1000, "broker-topic":"myTopic" }`;
